  ...
  return `<div class="basket__dish">
            ...
            <div class="basket__dishPriceContainter">
              <div class="basket__buttonContainer">
                <button type="button" class="quantityBtn quantityBtn--delete">
                ...
                <button type="button" class="quantityBtn">
                +
                </button>
              </div>
...
export function getBasketPriceTemplate(basket) {
  return `<table class="basket__table">
            <tr>
              <td>Subtotal</td>
              <td>${basket.summery.subTotal.toFixed(2)}€</td>
            </tr>
            ...
            <tr>
              <th>Total</th>
              <th>${basket.summery.total.toFixed(2)}€</th>
            </tr>
          </table>`;
}
