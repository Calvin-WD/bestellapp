  ...
  return `<div class="basket__dish">
            ...
            <div class="basket__dishPriceContainter">
              <div class="basket__buttonContainer">
                ${getQuantitySubtractionButtonTemplate(basketDish)}
                ${getDeleteButtonTemplate(basketDish)}
...
function getDeleteButtonTemplate(basketDish) {
  return `<button
          id="delButton-${basketDish.id}"
          type="button"
          class="quantityBtn quantityBtn--delete"
...
function getQuantitySubtractionButtonTemplate(basketDish) {
  return `<button
            id="subButton-${basketDish.id}"
            type="button"
            class="quantityBtn dNone"
